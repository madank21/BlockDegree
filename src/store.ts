...
export const INITIAL_DEGREES: Degree[] = [
  {
    ...
    degreeHash: generateHash('MADAN KUMAR|STU-2024-001|BS Computer Science|IQRA University|2024-06-15'),
  ...
  {
    id: 'deg-2',
    studentName: 'NOOR AWAN',
    studentId: 'STU-2024-002',
    program: 'BS Software Engineering',
    university: 'IQRA University',
    graduationDate: '2024-06-15',
    degreeHash: generateHash('NOOR AWAN|STU-2024-002|BS Software Engineering|IQRA University|2024-06-15'),
  ...
  {
    id: 'deg-3',
    studentName: 'KIRAN DEVI',
    studentId: 'STU-2024-003',
    program: 'BS Information Technology',
    university: 'KARACHI University',
    graduationDate: '2024-07-20',
    degreeHash: generateHash('KIRAN DEVI|STU-2024-003|BS Information Technology|XYZ University|2024-07-20'),
  ...
  },
  {
    ...
    degreeHash: generateHash('MADAN KUMAR|STU-2024-001|MS Data Science|KARACHI University|2024-12-20'),
  ...
  },
  {
    ...
    university: 'IQRA University',
    graduationDate: '2024-12-20',
    degreeHash: generateHash('KIRAN DEVI|STU-2024-003|MS Artificial Intelligence|IQRA University|2024-12-20'),
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  { id: 'log-1', action: 'DEGREE_ISSUED', actor: 'IQRA University', role: 'university', target: 'Ali Ahmed - BS Computer Science', timestamp: new Date(now - 86400000 * 30).toISOString(), txHash: INITIAL_DEGREES[0].blockchainTxHash },
  { id: 'log-2', action: 'DEGREE_ISSUED', actor: 'IQRA University', role: 'university', target: 'Sara Khan - BS Software Engineering', timestamp: new Date(now - 86400000 * 25).toISOString(), txHash: INITIAL_DEGREES[1].blockchainTxHash },
  { id: 'log-3', action: 'DEGREE_ISSUED', actor: 'KARACHI University', role: 'university', target: 'Ahmed Raza - BS Information Technology', timestamp: new Date(now - 86400000 * 20).toISOString(), txHash: INITIAL_DEGREES[2].blockchainTxHash },
  ...
  { id: 'log-5', action: 'DEGREE_ISSUED', actor: 'KARACHI University', role: 'university', target: 'Ali Ahmed - MS Data Science', timestamp: new Date(now - 86400000 * 10).toISOString(), txHash: INITIAL_DEGREES[3].blockchainTxHash },
  ...
  { id: 'log-8', action: 'DEGREE_ISSUED', actor: 'KARACHI University', role: 'university', target: 'Sara Khan - MS Artificial Intelligence', timestamp: new Date(now - 86400000 * 5).toISOString(), txHash: INITIAL_DEGREES[4].blockchainTxHash },
  { id: 'log-9', action: 'DEGREE_REVOKED', actor: 'KARACHI University', role: 'university', target: 'Sara Khan - MS Artificial Intelligence', timestamp: new Date(now - 86400000 * 4).toISOString(), txHash: '0xf6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1' },
